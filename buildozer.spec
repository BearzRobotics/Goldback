...
title = GoldBack Calculator

# (str) Package name
package.name = Goldback
...
requirements = python3,kivy==2.0.0,https://github.com/kivymd/KivyMD/archive/master.zip,sdl2_ttf==2.0.15,pillow,beautifulsoup4,requests,urllib3,chardet,idna
